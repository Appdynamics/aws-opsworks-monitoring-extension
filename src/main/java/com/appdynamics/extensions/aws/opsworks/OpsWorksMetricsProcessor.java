...
public class OpsWorksMetricsProcessor implements MetricsProcessor {
	...
	public OpsWorksMetricsProcessor(List<IncludeMetric> includeMetrics, List<Dimension> dimensions) {
	...
	private List<DimensionFilter> getDimensionFilters() {
		...
		for (Dimension dimension : dimensions) {
			DimensionFilter opsDimensionFilter = new DimensionFilter();
			opsDimensionFilter.withName(dimension.getName());
			dimensionFilters.add(opsDimensionFilter);
		}
